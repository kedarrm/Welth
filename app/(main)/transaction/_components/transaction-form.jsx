    ...
    return (
        <form className='space-y-8' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='grid gap-6 md:grid-cols-2'>
                <div className='space-y-2'>
                    <label className='test-sm font-medium'>Amount</label>
                    <Input
                        type="number"
                        step="0.01"
                        placeholder="0.00"
                ...
                <div className='space-y-2'>
                    <label className='test-sm font-medium'>Account</label>
                    <Select
            ...
            {isRecurring && (
                <div className='space-y-2'>
                    <label className='test-sm font-medium'>Recurring Interval</label>
                    <Select
